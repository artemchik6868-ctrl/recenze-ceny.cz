/**
 * RO ops health check — pipeline, content audit, smoke, secrets, cron, TerraLeads probe.
...
const outPath = resolve(cacheDir, "ops-health-ro.json");
writeFileSync(outPath, JSON.stringify(report, null, 2), "utf8");
console.log(`\nWrote ${outPath}`);
console.log(`\nops-health-ro: ${failed === 0 ? "OK" : `FAIL (${failed} step(s))`}`);
