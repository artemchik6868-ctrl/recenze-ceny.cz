...
const TEMPLATE_GLOBS = [
  "src/lib/i18n.hu.ts",
  "src/lib/content.hu.ts",
  "src/lib/niche-content.hu.ts",
  "src/lib/legal.hu.ts",
  "src/lib/category-descriptors.hu.ts",
  "src/lib/lead-errors.hu.ts",
  "src/lib/seo-alt.ts",
  "src/lib/seo-meta.ts",
  ...
  "src/data/review-templates-cat.hu.ts",
  "src/data/review-templates-niche.hu.ts",
  "src/data/review-templates-slug.hu.ts",
  "src/data/review-templates-theme.hu.ts",
  "src/lib/reviews.ts",
];
...
if (leaks) {
  console.log(`\naudit-locale-hu: ${leaks} leak(s) — run translate:ui:cz / fix hardcoded "de"`);
  process.exit(1);
}
console.log("audit-locale-hu: OK");
