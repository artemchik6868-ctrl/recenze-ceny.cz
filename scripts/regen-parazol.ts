...
if (!offer) {
  console.error("Parazol (cpa_tl:13593) not found");
  process.exit(1);
}

console.log(`pipeline=${PIPELINE_VERSION} — regen Parazol (cpa_tl:13593)\n`);
const t0 = Date.now();
...
console.log(`url: https://recenze-ceny.cz/parasites/parazol-13593`);
