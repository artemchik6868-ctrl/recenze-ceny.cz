/**
 * Audit AT locale templates for PL/SL/CZ market leakage.
...
const BAD = [
  ...
  /\b(erfahrungen-check\.de|Erfahrungen Check|Eisenbahnstraße|10997 Berlin)\b/i,
  /\b(in ganz Deutschland|Deutschland)\b/i,
  /ą|ć|ę|ł|ń|ó|ś|ź|ż/i,
];
...
if (issues) {
  console.log(`\naudit-locale-at: ${issues} potential leak(s)`);
  process.exitCode = 1;
} else {
  console.log("audit-locale-at: OK");
}
