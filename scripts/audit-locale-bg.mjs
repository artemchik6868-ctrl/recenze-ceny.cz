/**
 * Audit BG locale templates for DE/PL/SL/Cyrillic leaks + hardcoded "de" in UI.
...
const TEMPLATE_GLOBS = [
  "src/lib/i18n.bg.ts",
  "src/lib/content.bg.ts",
  "src/lib/niche-content.bg.ts",
  "src/lib/legal.bg.ts",
  "src/lib/category-descriptors.bg.ts",
  "src/lib/lead-errors.bg.ts",
  "src/lib/seo-alt.ts",
  "src/lib/seo-meta.ts",
  ...
  "src/data/review-templates-cat.bg.ts",
  "src/data/review-templates-niche.bg.ts",
  "src/data/review-templates-slug.bg.ts",
  "src/data/review-templates-theme.bg.ts",
];
...
if (leaks) {
  console.log(`\naudit-locale-bg: ${leaks} leak(s) — run translate:ui:cz / fix hardcoded "de"`);
  process.exit(1);
}
console.log("audit-locale-bg: OK");
